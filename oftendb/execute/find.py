...
def file23str(searchfile,keyword):
  ...
  for line in f1:
    if len(line) < 2:
      ...
      bang=key
    elif bang==key and "_@" not in line and 'time_:' not in line:
      middleStr=middleStr+line
      ...
      middleStr=''
      bang='back'
    elif bang=='back' and "_@" in line and key not in line:
